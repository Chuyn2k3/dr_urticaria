...
import 'package:dr_urticaria/medical_record_v2/cubits/chronic_initital/chronic_initial_state.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(
            ...
            value: _record.medicalHistory?.pastOutbreakHistory,
            onChanged: (value) =>
                _record.medicalHistory?.pastOutbreakHistory = value,
            maxLines: 3,
            hint: 'Mô tả tự do',
          ),
          CustomRadioGroup(
            label: 'Đã từng điều trị trước đó',
            value: _record.medicalHistory?.previousTreatment,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(
                () => _record.medicalHistory?.previousTreatment = value),
          ),
          CustomTextField(
            label:
                'Chi tiết thuốc, liều, thời gian, tuân thủ, đáp ứng điều trị',
            value: _record.medicalHistory?.previousTreatmentDetails,
            onChanged: (value) =>
                _record.medicalHistory?.previousTreatmentDetails = value,
            maxLines: 3,
          ),
          const SizedBox(height: 16),
          const Text(
          ...
          CustomRadioGroup(
            ...
            value: _record.medicalHistory?.personalAtopyHistory,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(
                () => _record.medicalHistory?.personalAtopyHistory = value),
          ),
          CustomRadioGroup(
            label: 'Tiền sử mắc bệnh tuyến giáp',
            value: _record.medicalHistory?.personalThyroidDiseaseHistory,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(() =>
                _record.medicalHistory?.personalThyroidDiseaseHistory = value),
          ),
          CustomRadioGroup(
            label: 'Tiền sử mắc bệnh tự miễn',
            value: _record.medicalHistory?.personalAutoimmuneHistory,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(() =>
                _record.medicalHistory?.personalAutoimmuneHistory = value),
          ),
          CustomTextField(
            label: 'Tiền sử mắc bệnh lý khác',
            value: _record.medicalHistory?.personalOtherDiseaseHistory,
            onChanged: (value) =>
                _record.medicalHistory?.personalOtherDiseaseHistory = value,
            maxLines: 3,
          ),
          CustomTextField(
            label: 'Tiền sử dị ứng thuốc hoặc thức ăn',
            value: _record.medicalHistory?.personalDrugFoodAllergyHistory,
            onChanged: (value) =>
                _record.medicalHistory?.personalDrugFoodAllergyHistory = value,
            maxLines: 3,
          ),
          CustomRadioGroup(
            label: 'Tiền sử phản vệ',
            value: _record.medicalHistory?.personalAnaphylaxisHistory,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(() =>
                _record.medicalHistory?.personalAnaphylaxisHistory = value),
          ),
          ...
          CustomRadioGroup(
            ...
            value: _record.medicalHistory?.familyChronicUrticariaHistory,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(() =>
                _record.medicalHistory?.familyChronicUrticariaHistory = value),
          ),
          CustomRadioGroup(
            label: 'Tiền sử gia đình mắc bệnh lý cơ địa',
            value: _record.medicalHistory?.familyAtopyHistory,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(
                () => _record.medicalHistory?.familyAtopyHistory = value),
          ),
          CustomRadioGroup(
            label: 'Tiền sử gia đình mắc bệnh tự miễn',
            value: _record.medicalHistory?.familyAutoimmuneHistory,
            options: const ['Có', 'Không', 'Không rõ'],
            onChanged: (value) => setState(
                () => _record.medicalHistory?.familyAutoimmuneHistory = value),
          ),
          CustomTextField(
            label: 'Chi tiết về bệnh của thành viên gia đình (nếu có)',
            value: _record.medicalHistory?.familyHistoryDetail,
            onChanged: (value) =>
                _record.medicalHistory?.familyHistoryDetail = value,
            maxLines: 3,
          ),
        ],
      ),
